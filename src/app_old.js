...
// Color scale for choropleth (White to Dark Red)
...
// Interpolated from white (#ffffff) to dark red (#8b0000)
const COLOR_PALETTE = [
    '#ffffff',  // < 10: white
    '#fff0f0',  // 10-500: very light pink
    '#ffe0e0',  // 500-1000: light pink
    '#ffc0c0',  // 1000-2000: lighter red
    '#ff9090',  // 2000-5000: pink
    '#ff5050',  // 5000-10000: light red
    '#e02020',  // 10000-20000: red
    '#b00000',  // 20000-30000: dark red
    '#8b0000'   // 30000+: very dark red
];
